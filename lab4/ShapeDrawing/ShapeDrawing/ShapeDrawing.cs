...
public class ShapeDrawingForm : Form
{
    ...
    ShapeDrawingAdapter sDA;
    SvgFileMaker svgFileMaker;
	...
	public ShapeDrawingForm()
	{
        ...
        svgFileMaker = new SvgFileMaker();
        sDA = new ShapeDrawingAdapter();
        // Listen to Paint event to draw shapes
        this.Paint += new PaintEventHandler(sDA.OnPaint); 
    ...
    private void openFileHandler(object sender, EventArgs e)
    {
        ...
        {
            sDA.getShapes = Parser.ParseShapes(dialog.FileName);
            svgFileMaker.getShapes = sDA.getShapes;
